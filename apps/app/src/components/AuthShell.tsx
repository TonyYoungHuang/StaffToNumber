  ...
  const copy =
    locale === "zh-CN"
      ? {
          ...
          accessTitle: "登录后免费编辑",
          accessBody: "上传一页 PDF 或一张乐谱图片，识别后可直接校对音符、节奏和小节属性。",
      ...
      : {
          ...
          accessBody: "Upload one PDF page or score image, then correct notes, rhythm, and measure attributes in the free editor.",
