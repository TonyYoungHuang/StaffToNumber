...
export const featureSeoRecords: Record<string, FeatureSeoRecord> = {
  ...
  "score-editor": {
    searchIntent: "Create sheet music or correct structured notation in a browser-based editor.",
    keywordCluster: "online sheet music maker and notation editor",
    ...
    screenshot: {
      ...
      width: 1425,
      height: 891,
      alt: "Online sheet music maker and editor with notation, revision controls and correction tools",
  ...
  "score-to-audio": {
    ...
    primaryKeyword: "sheet music player",
    ...
    screenshot: {
      ...
      width: 1425,
      height: 891,
      alt: "Online sheet music player with tempo, loop, part controls and audio export jobs",
  ...
  "musicxml-midi": {
    searchIntent: "Edit MusicXML and convert between portable MusicXML and MIDI score formats.",
    keywordCluster: "online MusicXML editor and MIDI conversion",
    ...
    screenshot: {
      ...
      width: 1425,
      height: 891,
      alt: "Online MusicXML editor showing a score before MIDI and Score JSON export",
