...
export const featureSeoRecords: Record<string, FeatureSeoRecord> = {
  ...
  "transpose-score": {
    ...
    schemas: commonSchemas,
    screenshot: {
      src: "/product/localized/en/feature-transpose-score-real.jpg",
      width: 1440,
      height: 900,
  ...
  "score-to-audio": {
    ...
    schemas: commonSchemas,
    screenshot: {
      src: "/product/localized/en/feature-score-to-audio-real.jpg",
      width: 1440,
      height: 900,
  ...
  "audio-to-score": {
    ...
    schemas: commonSchemas,
    screenshot: {
      src: "/product/localized/en/feature-audio-to-score-real.jpg",
      width: 1440,
      height: 900,
  ...
  "musicxml-midi": {
    ...
    schemas: commonSchemas,
    screenshot: {
      src: "/product/localized/en/feature-musicxml-midi-real.jpg",
      width: 1440,
      height: 900,
  ...
  pricing: {
    ...
    schemas: commonSchemas,
    screenshot: {
      src: "/product/localized/en/feature-pricing-real.jpg",
      width: 1440,
      height: 900,
