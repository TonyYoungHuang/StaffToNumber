...
const englishContent: Record<PriorityAnswerPageSlug, FeatureAnswerContent> = {
  ...
  "score-editor": {
    ...
    video: { src: "/product/demo-score-editor-en.mp4", poster: "/product/demo-score-editor-en-poster.jpg", title: "Short product demo: correcting a structured score revision" },
  },
  "transpose-score": {
    ...
    video: { src: "/product/demo-transpose-score-en.mp4", poster: "/product/demo-transpose-score-en-poster.jpg", title: "Short product demo: transposing a score into a new revision" },
  },
  "score-to-audio": {
    ...
    video: { src: "/product/demo-score-to-audio-en.mp4", poster: "/product/demo-score-to-audio-en-poster.jpg", title: "Short product demo: turning a structured score into practice audio" },
  },
};
...
const chineseContent: Record<PriorityAnswerPageSlug, FeatureAnswerContent> = {
  ...
  "score-editor": {
    ...
    video: { src: "/product/demo-score-editor.mp4", poster: "/product/demo-score-editor-poster.jpg", title: "产品短演示：校正结构化乐谱版本" },
  },
  "transpose-score": {
    ...
    video: { src: "/product/demo-transpose-score.mp4", poster: "/product/demo-transpose-score-poster.jpg", title: "产品短演示：把移调结果保存为新版本" },
  },
  "score-to-audio": {
    ...
    video: { src: "/product/demo-score-to-audio.mp4", poster: "/product/demo-score-to-audio-poster.jpg", title: "产品短演示：把结构化乐谱转换成练习音频" },
  },
};
