...
function baseContainerEnvironment(env: Bindings) {
  ...
  return {
    ...
    PADDLE_STARTER_MONTHLY_PRICE_ID: paddleEnabled ? env.PADDLE_STARTER_MONTHLY_PRICE_ID ?? "" : "",
    PADDLE_STARTER_ANNUAL_PRICE_ID: paddleEnabled ? env.PADDLE_STARTER_ANNUAL_PRICE_ID ?? "" : "",
    PADDLE_CONVERTER_PRO_MONTHLY_PRICE_ID: paddleEnabled ? env.PADDLE_CONVERTER_PRO_MONTHLY_PRICE_ID ?? "" : "",
    PADDLE_CONVERTER_PRO_ANNUAL_PRICE_ID: paddleEnabled ? env.PADDLE_CONVERTER_PRO_ANNUAL_PRICE_ID ?? "" : "",
