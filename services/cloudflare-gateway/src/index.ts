...
type Bindings = {
  ...
  STRIPE_CONVERTER_PRO_MONTHLY_PRICE_ID?: string;
  STRIPE_CONVERTER_PRO_ANNUAL_PRICE_ID?: string;
  STRIPE_MANAGED_PAYMENTS_ENABLED: string;
  PADDLE_API_KEY?: string;
  PADDLE_WEBHOOK_SECRET?: string;
  PADDLE_STARTER_MONTHLY_PRICE_ID?: string;
  PADDLE_STARTER_ANNUAL_PRICE_ID?: string;
  PADDLE_CONVERTER_PRO_MONTHLY_PRICE_ID?: string;
  PADDLE_CONVERTER_PRO_ANNUAL_PRICE_ID?: string;
  PADDLE_PRO_MONTHLY_PRICE_ID?: string;
  PADDLE_PRO_ANNUAL_PRICE_ID?: string;
  PADDLE_STUDIO_MONTHLY_PRICE_ID?: string;
  PADDLE_STUDIO_ANNUAL_PRICE_ID?: string;
...
function baseContainerEnvironment(env: Bindings) {
  ...
  return {
    ...
    STRIPE_STARTER_MONTHLY_PRICE_ID: stripeEnabled ? env.STRIPE_STARTER_MONTHLY_PRICE_ID ?? "" : "",
    STRIPE_STARTER_ANNUAL_PRICE_ID: stripeEnabled ? env.STRIPE_STARTER_ANNUAL_PRICE_ID ?? "" : "",
    STRIPE_CONVERTER_PRO_MONTHLY_PRICE_ID: stripeEnabled ? env.STRIPE_CONVERTER_PRO_MONTHLY_PRICE_ID ?? "" : "",
    STRIPE_CONVERTER_PRO_ANNUAL_PRICE_ID: stripeEnabled ? env.STRIPE_CONVERTER_PRO_ANNUAL_PRICE_ID ?? "" : "",
    ...
    PADDLE_STARTER_MONTHLY_PRICE_ID: paddleEnabled ? env.PADDLE_STARTER_MONTHLY_PRICE_ID ?? env.PADDLE_PRO_MONTHLY_PRICE_ID ?? "" : "",
    PADDLE_STARTER_ANNUAL_PRICE_ID: paddleEnabled ? env.PADDLE_STARTER_ANNUAL_PRICE_ID ?? env.PADDLE_PRO_ANNUAL_PRICE_ID ?? "" : "",
    PADDLE_CONVERTER_PRO_MONTHLY_PRICE_ID: paddleEnabled ? env.PADDLE_CONVERTER_PRO_MONTHLY_PRICE_ID ?? env.PADDLE_STUDIO_MONTHLY_PRICE_ID ?? "" : "",
    PADDLE_CONVERTER_PRO_ANNUAL_PRICE_ID: paddleEnabled ? env.PADDLE_CONVERTER_PRO_ANNUAL_PRICE_ID ?? env.PADDLE_STUDIO_ANNUAL_PRICE_ID ?? "" : "",
