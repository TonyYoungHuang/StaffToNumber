  ...
  "zh-CN": [
    {
      ...
      resources: ["每月 50 个后台任务", "10 GB 文件存储", "个人乐谱库、修订记录与开放曲库", "按月续费，可随时停止后续续费"],
      cta: "选择 Starter 月付",
      featured: false,
    },
    {
      ...
      resources: ["每月 50 个后台任务，按月重置", "10 GB 文件存储", "相比连续月付一年节省 $46.88", "个人乐谱库、修订记录与开放曲库"],
      cta: "选择 Starter 年付",
      featured: true,
    },
    {
      ...
      resources: ["每月 200 个后台任务", "50 GB 文件存储", "个人乐谱库、修订记录与开放曲库", "按月续费，可随时停止后续续费"],
    ...
    },
    {
      ...
      resources: ["每月 200 个后台任务，按月重置", "50 GB 文件存储", "相比连续月付一年节省 $80.88", "个人乐谱库、修订记录与开放曲库"],
  ...
  en: [
    {
      ...
      resources: ["50 server jobs each month", "10 GB file storage", "Personal library, revision history, and open score catalog", "Monthly renewal with no long commitment"],
    ...
    },
    {
      ...
      resources: ["50 server jobs monthly, reset each month", "10 GB file storage", "Save $46.88 versus twelve monthly payments", "Personal library, revision history, and open score catalog"],
    ...
    },
    {
      ...
      resources: ["200 server jobs each month", "50 GB file storage", "Personal library, revision history, and open score catalog", "Monthly renewal with no long commitment"],
    ...
    },
    {
      ...
      resources: ["200 server jobs monthly, reset each month", "50 GB file storage", "Save $80.88 versus twelve monthly payments", "Personal library, revision history, and open score catalog"],
...
const FREE_PLAN_CATALOG: Record<SupportedLocale, PricingPlanDisplay> = {
  "zh-CN": {
    ...
    resources: ["每月最多 25 个后台任务，按月重置", "1 GB 文件存储", "开放曲库浏览与 CC0 文件下载", "无需信用卡，免费项目长期保留"],
    cta: "免费创建乐谱",
    featured: false,
  },
  en: {
    ...
    resources: ["Up to 25 server jobs monthly, reset each month", "1 GB file storage", "Open score library and CC0 downloads", "No credit card required; keep the free project"],
