  ...
  "zh-CN": [
    {
      ...
      benefits: ["不限一个免费乐谱项目", "在线乐谱编辑与校正", "练习播放模式与智能乐谱移调", "五线谱／简谱互转", "版本历史、分享协作及 MusicXML／MIDI 转换"],
      resources: ["每月 50 个后台任务", "个人乐谱库与修订记录", "开放曲库浏览与 CC0 文件下载", "按月续费，可随时停止后续续费"],
      cta: "选择 Starter 月付",
      featured: false,
    },
    {
      ...
      cycle: "年付",
      price: "$49",
      unitPrice: "$0.082 / 后台任务",
      credits: "50 积分 / 月",
      audience: "适合长期使用并希望降低任务成本的个人用户",
      benefits: ["包含 Starter 月付全部正式能力", "在线乐谱编辑与校正", "练习播放、智能移调与简谱互转", "版本历史、分享协作及 MusicXML／MIDI 转换", "每月 50 积分，按月重置"],
      resources: ["相比连续月付一年节省 $46.88", "个人乐谱库与修订记录", "开放曲库浏览与 CC0 文件下载", "当前已开放的 MusicXML／MIDI／PDF 等格式"],
      cta: "选择 Starter 年付",
      featured: true,
    },
    {
      ...
      cycle: "月付",
      price: "$14.99",
      unitPrice: "$0.075 / 后台任务",
      credits: "200 积分 / 月",
      audience: "适合每月处理更多乐谱的高频个人用户",
      benefits: ["包含 Starter 的全部正式能力", "在线乐谱编辑与校正", "练习播放、智能移调与简谱互转", "版本历史、分享协作及 MusicXML／MIDI 转换", "每月 200 个后台任务"],
      resources: ["更高的月度处理容量", "个人乐谱库与修订记录", "开放曲库浏览与 CC0 文件下载", "按月续费，可随时停止后续续费"],
    ...
    },
    {
      ...
      cycle: "年付",
      price: "$99",
      unitPrice: "$0.041 / 后台任务",
      credits: "200 积分 / 月",
      audience: "适合长期、高频处理个人乐谱的用户",
      benefits: ["包含 Converter Pro 月付全部正式能力", "在线乐谱编辑与校正", "练习播放、智能移调与简谱互转", "版本历史、分享协作及 MusicXML／MIDI 转换", "每月 200 积分，按月重置"],
      resources: ["相比连续月付一年节省 $80.88", "个人乐谱库与修订记录", "开放曲库浏览与 CC0 文件下载", "当前已开放的 MusicXML／MIDI／PDF 等格式"],
  ...
  en: [
    {
      ...
      cycle: "Monthly",
      price: "$7.99",
      unitPrice: "$0.16 per server job",
      credits: "50 credits / month",
      audience: "For people who regularly process personal scores",
      benefits: ["More than the one free score project", "Online Sheet Music Editor", "Playback & Practice Mode with Smart Sheet Music Transposer", "Staff ↔ Jianpu Converter", "Version History, Share & Collaborate, and MusicXML & MIDI Converter"],
      resources: ["50 server jobs each month", "Personal library and revision history", "Open score library and CC0 downloads", "Monthly renewal with no long commitment"],
    ...
    },
    {
      ...
      cycle: "Annual",
      price: "$49",
      unitPrice: "$0.082 per server job",
      credits: "50 credits / month",
      audience: "For long-term individual use at a lower per-job cost",
      benefits: ["All formal Starter monthly capabilities", "Online Sheet Music Editor", "Playback, smart transposition, and Staff ↔ Jianpu", "Version History, Share & Collaborate, and MusicXML & MIDI", "50 credits reset each month"],
      resources: ["Save $46.88 versus twelve monthly payments", "Personal library and revision history", "Open score library and CC0 downloads", "Currently available MusicXML, MIDI, and PDF formats"],
    ...
    },
    {
      ...
      cycle: "Monthly",
      price: "$14.99",
      unitPrice: "$0.075 per server job",
      credits: "200 credits / month",
      audience: "For individuals who process more scores each month",
      benefits: ["All formal Starter capabilities", "Online Sheet Music Editor", "Playback, smart transposition, and Staff ↔ Jianpu", "Version History, Share & Collaborate, and MusicXML & MIDI", "200 server jobs each month"],
      resources: ["Higher monthly processing capacity", "Personal library and revision history", "Open score library and CC0 downloads", "Monthly renewal with no long commitment"],
    ...
    },
    {
      ...
      cycle: "Annual",
      price: "$99",
      unitPrice: "$0.041 per server job",
      credits: "200 credits / month",
      audience: "For sustained, high-frequency personal score processing",
      benefits: ["All formal Converter Pro monthly capabilities", "Online Sheet Music Editor", "Playback, smart transposition, and Staff ↔ Jianpu", "Version History, Share & Collaborate, and MusicXML & MIDI", "200 credits reset each month"],
      resources: ["Save $80.88 versus twelve monthly payments", "Personal library and revision history", "Open score library and CC0 downloads", "Currently available MusicXML, MIDI, and PDF formats"],
...
const FREE_PLAN_CATALOG: Record<SupportedLocale, PricingPlanDisplay> = {
  "zh-CN": {
    ...
    price: "$0",
    unitPrice: "一个完整乐谱项目",
    credits: "1 个完整乐谱 · 25 后台任务 / 月",
    audience: "适合先用一份完整乐谱体验全部项目级能力",
    benefits: ["终身创建一个完整乐谱项目", "在线乐谱编辑与校正", "练习播放、智能移调及五线谱／简谱互转", "版本历史、分享协作及 MusicXML／MIDI 转换", "该免费项目内使用现有项目级功能"],
    resources: ["每月最多 25 个后台任务，按月重置", "开放曲库浏览与 CC0 文件下载", "无需信用卡，免费项目长期保留", "升级后可创建和处理更多乐谱"],
    cta: "免费创建乐谱",
    featured: false,
  },
  en: {
    ...
    credits: "1 complete score · 25 server jobs / month",
    audience: "Use every current project-level tool with one complete score",
    benefits: ["Create one complete score project for life", "Online Sheet Music Editor", "Playback, smart transposition, and Staff ↔ Jianpu", "Version History, Share & Collaborate, and MusicXML & MIDI", "Current project-level tools remain available on that free score"],
    resources: ["Up to 25 server jobs monthly, reset each month", "Open score library and CC0 downloads", "No credit card required; keep the free project", "Upgrade to create and process more scores"],
